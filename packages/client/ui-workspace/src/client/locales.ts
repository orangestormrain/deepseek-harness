...
export const zh = {
  ...
  'delete.session.desc': '将永久删除“{name}”及其分支会话的全部记录。此操作无法撤销。',
...
export const en = {
  ...
  'delete.session.title': 'Delete session permanently',
  'delete.session.desc': 'This permanently deletes “{name}” and every branch session record. This action cannot be undone.',
