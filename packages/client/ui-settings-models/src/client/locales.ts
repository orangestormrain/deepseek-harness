...
export const en = {
  ...
  oauthSignIn: 'Sign in with OpenAI account',
  oauthSignOut: 'Sign out',
  oauthEnable: 'Enable provider',
  oauthConnected: 'Signed in',
  oauthDisconnected: 'Not signed in',
  oauthSignedInAs: 'Signed in as {account}',
  oauthStarting: 'Starting sign-in…',
  oauthBrowserHint: 'Complete sign-in in the browser that just opened. You can close it when it says done.',
  oauthOpenBrowser: 'Open the sign-in page',
  oauthDeviceHint: 'Enter this code at the verification page to connect:',
  oauthSubmit: 'Submit',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  oauthSignIn: '登录 OpenAI 账号',
  oauthSignOut: '退出登录',
  oauthEnable: '启用提供方',
  oauthConnected: '已登录',
  oauthDisconnected: '未登录',
  oauthSignedInAs: '已登录：{account}',
  oauthStarting: '正在启动登录…',
  oauthBrowserHint: '请在刚打开的浏览器页面中完成登录；页面提示完成后即可关闭。',
  oauthOpenBrowser: '打开登录页面',
  oauthDeviceHint: '请在验证页面输入以下代码以完成连接：',
  oauthSubmit: '提交',
  oauthCancel: '取消登录',
}
